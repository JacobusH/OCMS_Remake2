		...
		<div class="rightpart">
			...
			<div class="tablepart">
				...
				<table border="0" cellspacing="0" cellpadding="0" class="middle">					
					...
					<tr>
					  <td width="13%" align="left">Property type</td>
					  <td width="2%" align="center">:</td>
					  <td width="85%" align="left">
					  <select name="sold_type" id="sold_type" class="form1" title="Property type">
						  <option value="">Select Property type</option>
						  <option value="quarterly_sold" <?if($row['sold_type'] == 'quarterly_sold'){echo 'selected';}?>>Quarterly sold</option>
						  <option value="all_sold" <?if($row['sold_type'] == 'all_sold'){echo "selected";}?>>All sold</option>
					  </select>
					</td>
					</tr> -->
					<tr>
