...
// GLOBAL variables
var server_path = "http://infor108/9999/ewcp/";
var scImgPath = server_path+'js/acp/cal_images/';
...
function ctlSpiffyCalendarBox(strVarName, strFormName, strTextBoxName, strBtnName, strDefaultValue, intBtnMode) {
	...
	switch (intBtnMode) {
		...
		case 1 :
			...
			break;
		case 2 :
			strBtnImg=strDefBtnImgPath+'btn_date2_over.gif';
			img_DateBtn_UP.src=strDefBtnImgPath+'btn_date2_over.gif';
			img_DateBtn_OVER.src=strDefBtnImgPath+'btn_date2_over.gif';
			img_DateBtn_DOWN.src=strDefBtnImgPath+'btn_date2_over.gif';
			img_DateBtn_DISABLED.src=strDefBtnImgPath+'btn_date2_over.gif';
			strBtnW = '22';
			strBtnH = '18';
			break;
	}
	...
	function makeCalendar(intWhatMonth,intWhatYear,bViewOnly) {
		...
		if (scNN6) {
			strOutput += strTemp +'<table width="195" border="3" class="cal-Table" cellspacing="0" cellpadding="0"><tr>';
		}
		else {
		...
		strOutput += '<table width="195" cellspacing="1" cellpadding="2" border="0"><tr>';
	...
	//		strHold+=this.varName+'.show();return false;">';
			...
			strHold+='<img align="absmiddle" border="0" name="' + this.btnName + '" src="' + strBtnImg +'" width="'+ strBtnW +'" height="'+ strBtnH +'" style="cursor: pointer;"></a>';
		}
